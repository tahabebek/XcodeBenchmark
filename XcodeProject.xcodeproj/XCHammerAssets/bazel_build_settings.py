...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/tahabebek/BazelEd/BenchmarkProjects/XcodeBenchmark//bazel',
    '/private/var/tmp/_bazel_tahabebek/ea06894acf9e8d0a18b7c9fce25481e4/execroot/__main__',
    'iphone',
    {
        'ios_armv7': [
    ...
    BazelFlagsSet(),
    {
        '//XcodeBenchmark/Screen3:Screen3': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
                    '--override_repository=xchammer_tulsi_aspects=/Users/tahabebek/BazelEd/BenchmarkProjects/XcodeBenchmark//external/xchammer/xchammer.app/Contents/Resources',
                    '--override_repository=tulsi=/Users/tahabebek/BazelEd/BenchmarkProjects/XcodeBenchmark//external/xchammer/xchammer.app/Contents/Resources',
                    '--aspects',
        ...
        '//XcodeBenchmark/Screen5:Screen5': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen1:Screen1': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark:App': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen4:Screen4': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark:AppLibrary': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen7:Screen7': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen8:Screen8': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen10:Screen10': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen2:Screen2': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen9:Screen9': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
        ...
        '//XcodeBenchmark/Screen6:Screen6': BazelFlagsSet(
            flags = BazelFlags(
                startup = [],
                build = [
                    '--build_event_publish_all_actions=true',
